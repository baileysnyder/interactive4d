<template>
  <div>
    ...
    <div class="main-content">
      <p>This is where our journey into the fourth dimension can truly begin. To gain a solid understanding of the fourth dimension, we first require a solid understanding of simple 4D shapes. We begin with the 4D sphere.</p>
      ...
      <p>First let's look at its slices. Slicing 3D objects created 2D slices, so now move up a dimension and slicing 4D objects will create 3D slices. In this scene, drag the w slider to move the 4D sphere in and out of our 3D universe:</p>
      ...
      <p>When the 4D sphere passes through our 3D universe, the slices it creates are 3D spheres whose size change with w distance. This is analogous to what happened when our 3D sphere passed through a 2D plane, creating circular slices whose size changed with z distance!</p>
      ...
      <p>We haven’t had to worry about rotations yet because rotating a 4D sphere doesn't affect its slice shape, but slices don't always give the full picture. Let’s see what we can learn from perspective projection.</p>
      ...
      <p>As we’ve seen a few times now, this idea of moving down a dimension can help a lot when observing 4D objects. Given some question about a 4D object's behavior, my general process to answer it looks like this:</p>
      <ol>
        <li>Consider the same scenario with an equivalent 3D object</li>
        <li>Imagine what the slices and projection of the 3D object would look like during movement and rotation</li>
