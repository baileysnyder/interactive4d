<template>
  <div>
    <h2 class="article-header">4D Cones and More</h2>
    <div class="main-content">
      <p>Place</p>
      <p>Holder</p>
      <SceneButtonSingle :sceneID="scenes.three.projHypercube" :text="'4D Cube Projection'" :imgName="'proj_cube.png'"></SceneButtonSingle>
    </div>
  </div>
</template>
