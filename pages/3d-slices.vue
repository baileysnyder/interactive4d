<template>
  <div>
    ...
    <div class="main-content">
      ...
      <p>Notice that each cube face adds at most 1 edge to the final slice. The highest number of edges on the slice is 6, which means all 6 faces of the cube are intersecting with the plane. Dragging the cube through edge first you can see that while the slice shape seems to transition smoothly, there’s actually a sudden point where one of the edges is completely replaced with another.</p>
