<template>
  <div>
    ...
    <div class="main-content">
      ...
      <p>I’d like to point out that this ends up being extremely useful. Whenever something in 4D confuses me, returning to these concepts often provides the most insight.</p>
      ...
      <p>I’d recommend playing with the cube’s rotation and position for a bit to see what different kinds of slice shapes you can make. This will come in handy later for 4D cubes.</p>
